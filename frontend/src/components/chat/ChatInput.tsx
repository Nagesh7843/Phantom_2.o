        ...
        <div className="absolute left-2 right-2 bottom-2 flex items-center justify-between pointer-events-auto">
          ...
          <div className="flex items-center gap-1">
            ...
            <div className="relative" ref={attachMenuRef}>
              ...
              {showAttachMenu && (
                <div className="absolute bottom-full left-0 mb-2 w-56 p-1.5 rounded-xl glass-dropdown border border-zinc-700/80 shadow-2xl z-50 bg-zinc-950/95 backdrop-blur-xl animate-fade-in">
