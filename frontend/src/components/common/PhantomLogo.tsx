...
/**
 * Sidebar Expand Icon matching exact ChatGPT reference UI:
 * Rounded frame with left sidebar divider and right-pointing expand chevron.
 */
export const SidebarExpandIconSvg: React.FC<{ className?: string }> = ({
  className = 'w-4 h-4',
}) => {
  return (
    <svg
